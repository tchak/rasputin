...
SC.Logger = SC.Object.create(
  ...
  */
  ...
  /**
    ...
    If you do not specify this value, it will default to SC.LOGGER_LEVEL_falseNE.

    @property: {Constant}
  */
  logRecordingLevel: SC.LOGGER_LEVEL_falseNE,
...
<pre>
  ...
  */
  debug: function(message, optionalFormatArgs) {
    ...
    SC.Logger._handleMessage(SC.LOGGER_LEVEL_DEBUG, true, message, arguments);
  },
  ...
  */
  debugWithoutFmt: function() {
    this._handleMessage(SC.LOGGER_LEVEL_DEBUG, false, null, arguments);
  },
  ...
  */
  debugGroup: function(message, optionalFormatArgs) {
    ...
    SC.Logger._handleGroup(SC.LOGGER_LEVEL_DEBUG, false, message, arguments);
  },

  debugGroupCollapsed: function(message, optionalFormatArgs) {
    // Implementation note:  To avoid having to put the SC.debugGroup()
    // shorthand variant inside a function wrapper, we'll avoid 'this'.
    SC.Logger._handleGroup(SC.LOGGER_LEVEL_DEBUG, true, message, arguments);
  },
  ...
  */
  info: function(message, optionalFormatArgs) {
    ...
    // variant inside a function wrapper, we'll avoid 'this'.
    SC.Logger._handleMessage(SC.LOGGER_LEVEL_INFO, true, message, arguments);
  },
  ...
  */
  infoWithoutFmt: function() {
    this._handleMessage(SC.LOGGER_LEVEL_INFO, false, null, arguments);
  },
  ...
  */
  infoGroup: function(message, optionalFormatArgs) {
    ...
    // shorthand variant inside a function wrapper, we'll avoid 'this'.
    SC.Logger._handleGroup(SC.LOGGER_LEVEL_INFO, false, message, arguments);
  },

  infoGroupCollapsed: function(message, optionalFormatArgs) {
    // Implementation note:  To avoid having to put the SC.infoGroup()
    // shorthand variant inside a function wrapper, we'll avoid 'this'.
    SC.Logger._handleGroup(SC.LOGGER_LEVEL_INFO, true, message, arguments);
  },
  ...
  */
  warn: function(message, optionalFormatArgs) {
    ...
    // variant inside a function wrapper, we'll avoid 'this'.
    SC.Logger._handleMessage(SC.LOGGER_LEVEL_WARN, true, message, arguments);
  ...
  */
  warnWithoutFmt: function() {
    this._handleMessage(SC.LOGGER_LEVEL_WARN, false, null, arguments);
  },
  ...
  */
  warnGroup: function(message, optionalFormatArgs) {
    ...
    // shorthand variant inside a function wrapper, we'll avoid 'this'.
    SC.Logger._handleGroup(SC.LOGGER_LEVEL_WARN, false, message, arguments);
  },

  warnGroupCollapsed: function(message, optionalFormatArgs) {
    // Implementation note:  To avoid having to put the SC.warnGroup()
    // shorthand variant inside a function wrapper, we'll avoid 'this'.
    SC.Logger._handleGroup(SC.LOGGER_LEVEL_WARN, true, message, arguments);
  },
  ...
  */
  error: function(message, optionalFormatArgs) {
    ...
    // variant inside a function wrapper, we'll avoid 'this'.
    SC.Logger._handleMessage(SC.LOGGER_LEVEL_ERROR, true, message, arguments);
  },
  ...
  */
  errorWithoutFmt: function() {
    this._handleMessage(SC.LOGGER_LEVEL_ERROR, false, null, arguments);
  },
  ...
  */
  errorGroup: function(message, optionalFormatArgs) {
    ...
    // shorthand variant inside a function wrapper, we'll avoid 'this'.
    SC.Logger._handleGroup(SC.LOGGER_LEVEL_ERROR, false, message, arguments);
  },

  errorGroupCollapsed: function(message, optionalFormatArgs) {
    // Implementation note:  To avoid having to put the SC.errorGroup()
    // shorthand variant inside a function wrapper, we'll avoid 'this'.
    SC.Logger._handleGroup(SC.LOGGER_LEVEL_ERROR, true, message, arguments);
  },
  ...
  */
  outputRecordedLogMessages: function(includeTimestamps) {
    ...
    var reporter        = this.get('reporter'),
        ...
        output, title, collapsed, newIndentation, disparity, j, jLen;
        ...
        if (message) {
          ...
          if (reporter.group) {
            ...
            if (disparity > 0) {
              ...
              // that is one smaller.
              this._outputGroup(type, timestampStr, newIndentation - 1, title, collapsed);
            }
  ...
  */
  log: function() {
    var reporter = get(this, 'reporter'),
        ret      = false;
  ...
  */
  group: function(title) {
    ...
    if (get(this, 'exists')  &&  (typeof reporter.group === "function")) {
  ...
  */
  groupEnd: function() {
    ...
    if (get(this, 'exists')  &&  (typeof reporter.groupEnd === "function")) {
      reporter.groupEnd();
    }
  },
  ...
  */
  dir: function() {
    ...
    if (get(this, 'exists')  &&  (typeof reporter.dir === "function")) {
  ...
  */
  dirxml: function() {
    ...
    if (get(this, 'exists')  &&  (typeof reporter.dirxml === "function")) {
  ...
  */
  profile: function(title) {
    ...
    if (get(this, 'exists')  &&  (typeof reporter.profile === "function")) {
  ...
  */
  profileEnd: function(title) {
    ...
    if (get(this, 'exists')  &&  (typeof reporter.profileEnd === "function")) {
  ...
  */
  time: function(name) {
    ...
    if (get(this, 'exists')  &&  (typeof reporter.time === "function")) {
      reporter.time(name);
      return true;
    }
    return false;
  ...
  */
  timeEnd: function(name) {
    ...
    if (get(this, 'exists')  &&  (typeof reporter.timeEnd === "function")) {
  ...
  */
  trace: function() {
    ...
    if (get(this, 'exists')  &&  (typeof reporter.trace === "function")) {
      reporter.trace();
      return true;
    }
    return false;
  ...
  init: function() {
    ...
    if (!get(this, 'logOutputLevel')) {
      if (SC.ENV.DEBUG === true) {
        set(this, 'logOutputLevel', SC.LOGGER_LEVEL_DEBUG);
      }
      else {
        set(this, 'logOutputLevel', SC.LOGGER_LEVEL_INFO);
      }
    }
  ...
  */
  _handleGroup: function(type, collapsed, title, originalArguments) {
    // Are we configured to show this type?
    var shouldOutput = this._shouldOutputType(type),
        shouldRecord = this._shouldRecordType(type),
    ...
    if (shouldOutput) {
      this._outputGroup(type, null, this._outputIndentationLevel, title, collapsed);
  ...
  */
  _shouldOutputType: function(type) {
    var logLevelMapping = this._LOG_LEVEL_MAPPING,
        ...
        currentLevel    = logLevelMapping[get(this, 'logOutputLevel')]  ||  0;
  ...
  */
  _shouldRecordType: function(type) {
    ...
    var logLevelMapping = this._LOG_LEVEL_MAPPING,
        level           = logLevelMapping[type]                           ||  0,
        currentLevel  = logLevelMapping[get(this, 'logRecordingLevel')]  ||  0;
  ...
  */
  _outputGroup: function(type, timestampStr, indentation, title, collapsed) {
    if (!get(this, 'exists')) return;
    ...
    var reporter = get(this, 'reporter'),
        func     = (collapsed && reporter.groupCollapsed) ? reporter.groupCollapsed : reporter.group,
        output;
  ...
  */
  _addRecordedMessageEntry: function(entry) {
    var recordedMessages = get(this, 'recordedLogMessages'),
        len;

    // Lazily create the array.
    if (!recordedMessages) {
      recordedMessages = [];
      set(this, 'recordedLogMessages', recordedMessages);
    }
    ...
    if (len > get(this, 'recordedLogMessagesMaximumLength')) {
      recordedMessages.splice(0, (len - get(this, 'recordedLogMessagesPruningMinimumLength')));
    }
...
SC.DebugSupport = SC.Mixin.create({
  debugOutput: function() {
    if (!SC.Logger._shouldOutputType || !SC.Logger._shouldOutputType(SC.LOGGER_LEVEL_DEBUG)) {
      return;
    }
    if (!this._debugEnableClassName()) {
      return;
    }

    var fn = arguments.callee.caller.toString(),
        methodName = this._debugFindMethodName(fn);

    SC.Logger.debugGroupCollapsed("%@::%@", this.toString(), methodName);
    var res = SC.$.makeArray(arguments);
    for (var i = 0, l = res.length; l > i; i++) {
      (typeof res[i] === 'object') ? SC.Logger.dir(res[i]) : SC.Logger.debugWithoutFmt(res[i]);
    }
    SC.Logger.debugGroupEnd();
  },

  d: SC.alias('debugOutput'),

  _debugFindMethodName: function(fn) {
    for (var method in this) {
      if (typeof this[method] === "function" && this[method].toString && this[method].toString() === fn) {
        return method;
      }
    }
    return 'anonymous';
  ...
  _debugEnableClassName: function() {
    return SC.ENV.DEBUG_CLASSES &&
      SC.ENV.DEBUG_CLASSES.some(function(classPath) {
        try {
          return SC.getPath(classPath) === this;
        } catch (e) {
          return false;
        }
      }, this);
